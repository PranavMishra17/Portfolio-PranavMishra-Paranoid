          ...
          >
            <header className="experience-modal-header">
              <div className="experience-modal-heading">
                <span className="experience-modal-eyebrow">Career</span>
                <h2 id="exp-modal-title">Professional Experience</h2>
              </div>
              <button
              ...
              <ol className="exp-timeline">
                {experiences.map((exp, i) => {
                  ...
                  return (
                    <motion.li
                      key={exp.id}
                      className={`exp-timeline-item${exp.isCurrent ? ' is-current' : ''}`}
                    ...
                    >
                      ...
                      <div className="exp-timeline-rail" aria-hidden="true">
                        <span className="exp-timeline-node" />
                      </div>

                      <article className="exp-timeline-card">
                        <div className="exp-card-head">
                          <div className="exp-card-head-text">
                            <h3 className="exp-card-title">{exp.title}</h3>
                            <div className="exp-card-meta">
                              <span className="exp-card-company">{exp.company}</span>
                              <span className="exp-card-sep" aria-hidden="true">·</span>
                              <span className="exp-card-loc">{exp.location}</span>
                              {exp.isCurrent && (
                                <span className="exp-card-current">Current</span>
                              )}
                            </div>
                          </div>
                          <img

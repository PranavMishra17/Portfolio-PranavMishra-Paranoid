...
export const ME = {
  ...
  last: 'Mishra',
  role: 'AI engineer',
  now: 'Founding LLM engineer at Alfred_',
  ...
  lines: [
    'Right now that is Alfred_, an assistant that runs 5,000+ people’s email, calendar and small obligations over text, chat and voice.',
    'Before that: voice agents, computer vision, virtual patients in Unreal, and a long tail of games. Computer science at UIC.',
  ],
};
...
export const ALFRED = {
  ...
  lede: 'An assistant that reads your email, keeps your calendar and does the small obligations — over text message, chat and voice. I own the side of it where being wrong is expensive.',
...
const PAPER_LINE = {
  ...
  'slm-teammedagents':
    'Whether several small models working as a team can stand in for one large one, and what that trade actually costs.',
};

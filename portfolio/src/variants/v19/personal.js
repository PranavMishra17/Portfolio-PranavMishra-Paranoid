...
export const BOOKS = [
  ...
  {
    id: 'witcher',
    cover: bookCover('witcher'),
    title: 'The Witcher, the whole series',
    author: 'Andrzej Sapkowski',
    note: 'Read it all after playing The Witcher 3. Amazing fantasy: the dread in the nature of that world is unlike anything else.',
    status: 'Favourite',
    spine: '#5a4a3a',
    sample: false,
  },
  {
    ...
    title: 'The Stranger',
    author: 'Albert Camus',
    note: 'One of the best ways into philosophy. The narrator is indifferent to everything, even his own life, and reading his mind was really something.',
    status: 'Favourite',
    spine: '#b8452f',
    sample: false,
  },
